...
1. fewer cells makes it less likely to capture these somewhat rare events

2. fewer cells makes the reference profile noisier and less representative of 
the 'baseline' expression levels across chromosomes, further limiting CNV 
calling
