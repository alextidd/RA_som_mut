...
```{r}
# load the metadata
sm <- readr::read_tsv("/lustre/scratch125/casm/team268im/lh22/Rheumatoid_Arthritis_Paper/Data/MetaData/sample_meta.tsv")

# load the muts and convert to list
load("/lustre/scratch125/casm/team268im/lh22/Rheumatoid_Arthritis_Paper/Figures/Figure_2/LCM_NanoSeq_Overlap/GOI/pileup_muts.rda")
...
# get annotations from dndscv output
mut_annots <-
  muts$exome %>%
  tibble::as_tibble() %>%
  dplyr::select(chr, pos, gene, ref, mut, type, tri, impact, aachange)
